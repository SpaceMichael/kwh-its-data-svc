...
public class BedCleansingRequest extends Auditable {
    ...
    @GenericGenerator(name = "booking_generator", strategy = "hk.org.ha.kcc.common.data.PrefixedSequenceIdGenerator", parameters = {
            @Parameter(name = "sequence_name", value = "booking_seq"),
