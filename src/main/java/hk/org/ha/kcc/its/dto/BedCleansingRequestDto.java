...
public class BedCleansingRequestDto {
  ...
  /*
   * private Boolean cleanBedChecked; // e.g 清潔工序 ->床 private Boolean cleanBedCurtainsChecked; //
   * e.g 清潔工序 ->床簾 private Boolean cleanEnvChecked; // e.g 清潔工序 ->環境
   */
  private String detergent;
  /*
   * private Boolean bleach; // e.g 漂白水 private Boolean tricel; // e.g tricel
   */
